...
<head>
  ...
  <title>Sabil Clinic | Pasien Baru</title>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:12px;">
                <thead>
                <tr>
					<th style="width:70px;">Tanggal Daftar</th>
                    <th>Nama</th>
                    <th>Jenis Kelamin</th>
                    <th>Alamat</th>
                    <th>Ke Dokter</th>
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/daftar/simpan_pasien'?>" method="post" enctype="multipart/form-data">
