...
<head>
  ...
  <title>Sabil Clinic | Data Dokter</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Tambah Dokter</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
          					   ...
          					   $nip=$i['dokter_nip'];
          					   $nama=$i['dokter_nama'];
                       $specialist=$i['dokter_specialist'];
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add Dokter</h4>
                    </div>
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnama" class="form-control" id="inputUserName" placeholder="Nama Dokter" required>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Specialist</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xspecialist" class="form-control" id="inputUserName" placeholder="Specialist" required>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body">
                                ...
                                <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama Dokter</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xnama" value="<?php echo $nama;?>" class="form-control" id="inputUserName" placeholder="Nama Dokter" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Specialist</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xspecialist" value="<?php echo $specialist;?>" class="form-control" id="inputUserName" placeholder="Specialist" required>
                                        </div>
                                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/>
                     <input type="hidden" value="<?php echo $photo;?>" name="gambar">
                            <p>Apakah Anda yakin mau menghapus dokter <b><?php echo $nama;?></b> ?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "Dokter Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "Dokter berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
